package com.sandsea.orderconsumer.config.swagger;

import com.google.common.collect.Lists;
import com.sandsea.orderconsumer.utils.StatusResponse;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sandsea"))
